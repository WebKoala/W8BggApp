...
namespace BGGApp
{
    public sealed partial class HubCollection : UserControl
    {
        ...
        public event EventHandler ChangeUserClicked;
        ...
        void ChangeUserLinkClicked(object sender, RoutedEventArgs e)
        {
            if (ChangeUserClicked != null)
                ChangeUserClicked(this, null);
        }
